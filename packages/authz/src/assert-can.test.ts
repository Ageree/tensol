...
describe('packages/authz :: assertCan deterministic-output matrix (C9 — 50+ cases)', () => {
  ...
  const cases: ReadonlyArray<{
    ...
    { role: 'platform_admin', action: 'create', resource: 'project', expected: true },
    { role: 'platform_admin', action: 'approve', resource: 'assessment', expected: true },
    // tenant_admin
    { role: 'tenant_admin', action: 'create', resource: 'user', expected: true },
    { role: 'tenant_admin', action: 'delete', resource: 'user', expected: true },
    { role: 'tenant_admin', action: 'create', resource: 'tenant', expected: true },
    ...
    { role: 'tenant_admin', action: 'create', resource: 'skill', expected: true },
    ...
    { role: 'security_lead', action: 'create', resource: 'user', expected: true },
    { role: 'security_lead', action: 'delete', resource: 'tenant', expected: true },
    ...
    { role: 'operator', action: 'approve', resource: 'assessment', expected: true },
    ...
    { role: 'operator', action: 'change_scope', resource: 'scope_rule', expected: true },
    { role: 'operator', action: 'change_tool_policy', resource: 'tool_policy', expected: true },
    ...
    { role: 'developer', action: 'change_scope', resource: 'scope_rule', expected: true },
    { role: 'developer', action: 'change_tool_policy', resource: 'tool_policy', expected: true },
    { role: 'developer', action: 'change_scope', resource: 'project', expected: true },
    { role: 'developer', action: 'change_tool_policy', resource: 'finding', expected: true },
    { role: 'developer', action: 'delete', resource: 'finding', expected: true },
    { role: 'developer', action: 'create', resource: 'project', expected: true },
    // auditor
    ...
    { role: 'auditor', action: 'create', resource: 'finding', expected: true },
    { role: 'auditor', action: 'update', resource: 'evidence', expected: true },
    { role: 'auditor', action: 'delete', resource: 'audit_log', expected: true },
    // viewer
    { role: 'viewer', action: 'read', resource: 'project', expected: true },
    { role: 'viewer', action: 'list', resource: 'finding', expected: true },
    { role: 'viewer', action: 'create', resource: 'finding', expected: true },
    { role: 'viewer', action: 'read', resource: 'audit_log', expected: true },
    { role: 'viewer', action: 'read', resource: 'tool_catalog', expected: true },
  ];
