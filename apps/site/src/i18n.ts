...
const en = {
  ...
  pillarsEyebrow: '// THREE THINGS THE ATTACKING BOT DOES BETTER THAN YOUR PENTESTER',
  pillars: [
    {
      n: '01',
      t: 'It does not sleep.',
      d: 'The bot finishes a full kill chain in 8 hours. Your pentester takes 8 weeks. By the time the report lands, the attacker is two breaches ahead.',
    },
    {
      n: '02',
      t: 'It tries everything.',
      d: '10,000 attack chains a night. Your pentester tries 50 in a week. One of them finds the SSRF in your file uploader. The other one will not.',
    },
    {
      n: '03',
      t: 'It costs $2 an hour.',
      d: 'A pentester is $200/hour. The bot is $2/hour and dropping. The attacker did this math last quarter. Your CFO has not.',
    },
  ],
  notScannerEyebrow: '// MANIFESTO',
  notScannerTitle: 'A real attack under your signature.',
  notScannerBlurb:
    'A goal-driven LLM agent that breaks in like a real attacker — but inside your scope and under your signature. High-impact actions need your sign-off, with a kill-switch in your dashboard. Every action lands in your audit log; every finding ships with a replay-hash. Authorized offensive capability, not tooling that leaked into open source.',
  ...
  steps: [
    {
      n: '01 ▸ SCOPE',
      t: 'Scope',
      d: 'Targets, allow/deny, testing window. Verified ownership only. We attack what you authorized — nothing else.',
    },
    {
      n: '02 ▸ RECON',
      t: 'Recon',
      d: 'Browser crawl, OpenAPI ingest. Full surface mapped in minutes — same way the attacker maps you.',
    },
    {
      n: '03 ▸ EXPLOIT',
      t: 'Exploit',
      d: 'Goal-driven LLM agent. Dozens of tries per minute. Tool policy enforces scope. High-impact gates on your signature.',
    },
    {
      n: '04 ▸ VALIDATE',
      t: 'Validate',
      d: 'Deterministic replay with the same seed. The bot hallucinates. Replay does not.',
    },
    {
      n: '05 ▸ REPORT',
      t: 'Report',
      d: 'Evidence-first. Replay-hash for verification on your side. Mappings: ATT&CK, NIST CSF, ATLAS, D3FEND.',
    },
  ],
  proofEyebrow: '// PROOF',
  proofTitle: 'The bot hallucinates. Replay does not.',
  proofBlurb:
    'Every confirmed finding ships with the request, the response, the screenshot, the OOB callback, the validator log, and a hash. Replay it on your side. Match the hash. If it does not replay, we never publish it. Hallucinated findings die in the validator, not in your inbox.',
  russiaEyebrow: '// REGION · RU',
  russiaTitle: 'When the attacking bot moves into RU — defense has to be here too.',
  russiaBlurb:
    'In your Yandex Cloud folder. 152-FZ. GOST R / FSTEC report appendices. Russian-language deliverables. Compliant retention. Your data, your jurisdiction, your regulator. Not a Boston startup that disappears the day sanctions hit.',
  supplyEyebrow: '// SUPPLY CHAIN',
  supplyTitle: 'Authorized offensive capability — not leaked tooling.',
  supplyBlurb:
    'Verified catalog. Pinned versions. Pinned mirrors. Every prompt, every payload, every callback in an immutable audit log. High-impact capabilities require per-target authorization. No "oops, our model leaked nuclei into open source last week".',
  ...
  rolesEyebrow: '// FOR',
  rolesTitle: 'Four people. One bot. On their side.',
  rolesList: [
    {
      t: 'Security Lead',
      d: 'Approves the engagement. Sees every chain the bot tried, every finding it confirmed, every gate it hit.',
    },
    {
      t: 'Pentest Operator',
      d: 'Drives the bot. Triages live findings as they land. Hits the kill-switch when needed.',
    },
    {
      t: 'Compliance Reviewer',
      d: 'Reads the delivered reports. GOST R / FSTEC / NIST CSF mappings. Read-only across tenants.',
    },
    {
      t: 'Developer / Owner',
      d: 'Owns the app under test. Reads findings, ships fixes, requests retest.',
    },
  ],
  ctaEyebrow: '// READY',
  ctaTitle: 'Want to see what AI finds in your stack?',
  ctaBody:
    'Sign the scope. Run it. Within 48 hours we show confirmed findings — replay-hashed, audit-logged, in your jurisdiction.',
  ctaSignin: 'I have a tenant',
  footerBlurb: 'Authorized attacking bot. In your scope, on your signature, under your audit log.',
  footerCols: [
    {
      h: 'PRODUCT',
      l: [
        ...
        { label: 'Status', href: 'https://status.tensol.dev', external: true },
      ],
    },
    {
      h: 'COMPANY',
      l: [
        ...
        { label: 'Disclosure', href: '/legal/dpa' },
  ...
  contact: {
    ...
    sub: 'All requests reach me within an hour. Tell me what you want pentested.',
    asideQuote: 'Every request reaches me within an hour. — Saveliy, founder',
    asideMeta: '// LEAD INTAKE · region eu',
    fName: 'Name',
    fEmail: 'Work email',
    fEmailHint: 'Free-mail (gmail/mail.ru/yandex) is rejected — use your corp domain.',
    fCompany: 'Company',
    fRole: 'Role',
    fRoleOptions: [
      'CISO',
    ...
    fSize: 'Company size',
    fSizeOptions: ['1–50', '51–500', '501–5000', '5000+'],
    fScope: 'What do you want covered',
    fScopeHint: 'Short scope: domains, app types, timeline.',
    fUrgency: 'Urgency',
    fUrgencyOptions: ['Within a week', '2–4 weeks', 'This quarter', 'Just exploring'],
    ...
    submitting: 'Sending…',
    successTitle: 'Got it.',
    successSub: 'I will reach out within an hour.',
    ...
    errInvalidEmail: 'Use your corporate email.',
  ...
  pricing: {
    ...
    plans: [
      {
        name: 'Starter',
        tagline: 'one product, one quarter',
        features: [
          '1 production target, 1 staging target',
          'Monthly recon refresh',
          'Browser-first exploit pipeline',
          'Deterministic validator on every finding',
          'Evidence + replay bundle per finding',
          'GOST R / FSTEC report appendix',
          '1 HITL approver seat · business-hours support',
        ],
      },
      {
        name: 'Growth',
        tagline: 'product portfolio, monthly cadence',
        features: [
          'Up to 5 production + 10 staging targets',
          'Weekly recon, continuous reassessment',
          'Everything in Starter, plus:',
          'Framework mappings: ATT&CK · NIST CSF · ATLAS · D3FEND',
          '5 HITL approver seats',
          'Custom report templates',
          '24×7 incident escalation · dedicated success engineer',
        ],
      },
      {
        name: 'Enterprise',
        tagline: 'multi-tenant, regulated industries',
        features: [
          'Unlimited targets, multi-tenant deployment',
          'Hosted in your Yandex Cloud folder · on-prem option',
          'Everything in Growth, plus:',
          'Custom validator policies · custom HITL workflows',
          'SOC 2 / ISO 27001 audit-ready evidence packs',
          'Executive QBRs · dedicated CSM + security engineer',
          'Custom retention, audit log export, SSO/SCIM',
        ],
      },
    ],
    faqEyebrow: '// FAQ',
...
const ru: TensolDict = {
  ...
  pillarsEyebrow: '// ТРИ ВЕЩИ, КОТОРЫЕ ИИ ДЕЛАЕТ ЛУЧШЕ ТВОЕГО ПЕНТЕСТЕРА',
  pillars: [
    {
      n: '01',
      t: 'Он не спит.',
      d: 'ИИ заканчивает цепочку атак за 8 часов. Твой пентестер — за 8 недель. Пока отчёт лежит в Jira, атакующий уже на два пробоя впереди.',
    },
    {
      n: '02',
      t: 'Он пробует всё.',
      d: '10 000 цепочек атак за ночь. Твой пентестер — 50 за неделю. Одна из них найдёт SSRF в твоём загрузчике файлов. Другая — нет.',
    },
    {
      n: '03',
      t: 'Он стоит $2 в час.',
      d: 'Пентестер — $200/час. ИИ — $2/час и дешевеет. Атакующий это посчитал в прошлом квартале. Твой финдир — пока нет.',
    },
  ],
  notScannerEyebrow: '// МАНИФЕСТ',
  notScannerTitle: 'Реальная атака под твою подпись.',
  notScannerBlurb:
    'Целеустремлённый ИИ-агент, который ломает как настоящий атакующий, но в твоём периметре и под твоей подписью. Высокоопасные действия — только под твою санкцию, со стоп-краном в твоей панели. Каждое действие фиксируется в журнале аудита, каждая уязвимость приходит с хэшем для воспроизведения. Авторизованная атакующая способность, а не утёкший в опенсорс инструмент.',
  ...
  steps: [
    {
      n: '01 ▸ ПЕРИМЕТР',
      t: 'Периметр',
      d: 'Цели атаки, белые/чёрные списки, окно тестирования. Только проверенное владение. Атакуем то, что ты разрешил — ничего больше.',
    },
    {
      n: '02 ▸ РАЗВЕДКА',
      t: 'Разведка',
      d: 'Обход через браузер, захват OpenAPI. Вся поверхность за минуты — так же, как картирует тебя атакующий.',
    },
    {
      n: '03 ▸ ЭКСПЛУАТАЦИЯ',
      t: 'Эксплуатация',
      d: 'Целеустремлённый ИИ-агент. Десятки попыток в минуту. Политика инструментов форсирует периметр. Высокоопасные действия — только под твою подпись.',
    },
    {
      n: '04 ▸ ВАЛИДАЦИЯ',
      t: 'Валидация',
      d: 'Детерминированное воспроизведение с тем же сидом. ИИ галлюцинирует. Воспроизведение — нет.',
    },
    {
      n: '05 ▸ ОТЧЁТ',
      t: 'Отчёт',
      d: 'Со свидетельствами. Хэш для воспроизведения на твоей стороне. Соответствия: ATT&CK, NIST CSF, ATLAS, D3FEND.',
    },
  ],
  proofEyebrow: '// ПРУФ',
  proofTitle: 'ИИ галлюцинирует. Воспроизведение — нет.',
  proofBlurb:
    'Каждая подтверждённая уязвимость — это запрос, ответ, скриншот, OOB-callback, лог валидатора и хэш. Воспроизведи у себя. Совпал хэш — было. Не совпал — мы не публикуем. Галлюцинации умирают в валидаторе, а не в твоей почте.',
  russiaEyebrow: '// РЕГИОН · РФ',
  russiaTitle: 'Когда атакующий ИИ переедет в РФ — оборона должна быть здесь.',
  russiaBlurb:
    'В твоей папке Yandex Cloud. 152-ФЗ. Приложения по ГОСТ Р / ФСТЭК. Отчёты на русском. Хранение по нормам, по умолчанию. Твои данные, твоя юрисдикция, твой регулятор. Не стартап из Бостона, который исчезнет в день первых санкций.',
  supplyEyebrow: '// SUPPLY CHAIN',
  supplyTitle: 'Авторизованная атакующая способность — не утёкшие инструменты.',
  supplyBlurb:
    'Проверенный каталог. Зафиксированные версии. Зафиксированные зеркала. Каждый промпт, пэйлоад, обратный вызов — в неизменяемом журнале аудита. Высокоопасные категории требуют подтверждения на каждой цели. Никаких «ой, наша модель случайно слила nuclei в опенсорс на прошлой неделе».',
  ...
  rolesTitle: 'Четыре человека. Один ИИ. На их стороне.',
  rolesList: [
    {
      t: 'Security Lead',
      d: 'Утверждает проект. Видит каждую цепочку, которую пробовал ИИ, каждую подтверждённую уязвимость, каждую контрольную точку, на которой он остановился.',
    },
    {
      t: 'Pentest Operator',
      d: 'Ведёт ИИ. Триажит находки в реальном времени, пока они приходят. Жмёт стоп-кран, когда нужно.',
    },
    {
      t: 'Compliance Reviewer',
      d: 'Читает доставленные отчёты. Соответствия ГОСТ Р / ФСТЭК / NIST CSF. Только чтение по тенантам.',
    },
    {
      t: 'Developer / Owner',
      d: 'Владеет приложением под тестом. Читает уязвимости, чинит, заказывает перепроверку.',
    },
  ],
  ctaEyebrow: '// ГОТОВЫ',
  ctaTitle: 'Хочешь увидеть, что найдёт у тебя ИИ?',
  ctaBody:
    'Подпиши периметр. Запусти. Через 48 часов покажем подтверждённые уязвимости — с хэшем для воспроизведения, в журнале аудита, в твоей юрисдикции.',
  ctaSignin: 'У меня уже есть тенант',
  footerBlurb:
    'Авторизованный атакующий ИИ. В твоём периметре, по твоей подписи, под твоим журналом аудита.',
  footerCols: [
    {
      h: 'ПРОДУКТ',
      l: [
        ...
        { label: 'Статус', href: 'https://status.tensol.dev', external: true },
      ],
    },
    {
      h: 'КОМПАНИЯ',
  ...
  // ── BEGIN:contact (owned by Agent C) ─────────────────────────────────
  contact: {
    eyebrow: '// ВХОДЯЩИЙ ЛИД',
    title: 'Напиши основателю.',
    sub: 'Все запросы доходят до меня в течение часа. Опиши, что хочешь пентестить.',
    asideQuote: 'Все запросы попадают ко мне в течение часа. — Савелий, основатель',
    asideMeta: '// ВХОДЯЩИЙ ЛИД · регион eu',
    fName: 'Имя',
    fEmail: 'Рабочий email',
    fEmailHint: 'Free-mail (gmail/mail.ru/yandex) не принимаются — нужен корпоративный домен.',
    fCompany: 'Компания',
    fRole: 'Роль',
    fRoleOptions: [
      'CISO',
    ...
    fSizeOptions: ['1–50', '51–500', '501–5000', '5000+'],
    fScope: 'Что нужно покрыть',
    fScopeHint: 'Короткий scope: домены, типы приложений, сроки.',
    fUrgency: 'Срочность',
    fUrgencyOptions: ['В течение недели', '2–4 недели', 'В этом квартале', 'Изучаем'],
    ...
    successSub: 'Я свяжусь в течение часа.',
    ...
    errInvalidEmail: 'Используй корпоративный email.',
  ...
  pricing: {
    navLabel: 'Тарифы',
    eyebrow: '// ТАРИФЫ · SALES-LED',
    title: 'Цена как у engagement.',
    sub: 'Tensol продаётся за engagement, а не за seat. Каждый пакет скоупится под твой периметр, модель авторизации и требования регулятора. Сначала разговор — потом цена.',
    contactCta: 'Запросить цену →',
    popularLabel: 'РЕКОМЕНДУЕМ',
    plans: [
      {
        name: 'Starter',
        tagline: 'один продукт, один квартал',
        features: [
          '1 production-цель + 1 staging-цель',
          'Ежемесячное обновление recon',
          'Browser-first exploit-конвейер',
          'Детерминированный валидатор для каждого finding',
          'Evidence + replay-пакет на каждый finding',
          'Приложение к отчёту по GOST R / FSTEC',
          '1 место HITL-approver · поддержка в рабочие часы',
        ],
      },
      {
        name: 'Growth',
        tagline: 'портфель продуктов, ежемесячная каденция',
        features: [
          'До 5 production + 10 staging целей',
          'Еженедельный recon, непрерывная переоценка',
          'Всё из Starter, плюс:',
          'Маппинг фреймворков: ATT&CK · NIST CSF · ATLAS · D3FEND',
          '5 мест HITL-approver',
          'Кастомные шаблоны отчётов',
          '24×7 эскалация · выделенный success-инженер',
        ],
      },
      {
        name: 'Enterprise',
        tagline: 'мульти-тенант, регулируемые отрасли',
        features: [
          'Без лимита целей, multi-tenant развёртывание',
          'Хостинг в твоём Yandex Cloud folder · опция on-prem',
          'Всё из Growth, плюс:',
          'Кастомные политики валидатора и HITL-workflows',
          'Evidence-пакеты, готовые к SOC 2 / ISO 27001 аудиту',
          'Executive QBR · выделенный CSM + security-инженер',
          'Кастомный retention, экспорт audit-лога, SSO/SCIM',
        ],
      },
    ],
    faqEyebrow: '// FAQ',
    faqTitle: 'Частые вопросы перед контактом.',
    faq: [
      {
        q: 'Почему нет опубликованных цен?',
        a: 'Потому что цена — это функция от скоупа. Те же шесть целей стоят разных денег в зависимости от data residency, регулятора и каденции ретестов. Не будем притворяться, что это не так, ради ценника per-seat.',
      },
      {
        q: 'Tensol — self-serve?',
        a: 'Нет. Каждый engagement начинается с разговора об авторизации. Мы верифицируем владение, согласовываем rules of engagement и только потом провижим тенант.',
      },
      {
        q: 'Как верифицируется скоуп?',
        a: 'Через DNS-доказательство, registrar-доказательство или подписанное письмо от владельца — какая модель удобнее security-команде. Нет верификации — нет engagement.',
      },
      {
        q: 'Что с data residency?',
        a: 'По умолчанию хостим в твоём Yandex Cloud folder для RU-клиентов и в EU-регионах для остальных. Enterprise может разворачиваться полностью on-prem.',
      },
      {
        q: 'Подписываете DPA / NDA?',
        a: 'Да. Подписываем взаимное NDA до первого технического созвона и полное DPA до провижинга тенанта. Шаблоны лежат на странице Trust.',
      },
      {
        q: 'Можно on-prem?',
        a: 'Только Enterprise. Поставляем закалённый VM-образ и Kubernetes-манифест плюс 4 недели совместного развёртывания с нашим security-инженером.',
      },
      {
        q: 'Сколько от первого контакта до первого finding?',
        a: 'Медиана — 9 рабочих дней для Starter, 14 для Growth — включая авторизацию, верификацию скоупа и провижинг тенанта. Enterprise on-prem — дольше.',
      },
    ],
    ctaTitle: 'Поговорим о scope?',
    ctaBody:
      'Расскажи, что вы защищаете, кто это владеет и под какой регулятор живёте. Вернёмся с предложением — обычно в течение одного рабочего дня.',
    ctaBtn: 'Связаться с фаундером ▸',
  },
  // ── END:pricing ─────────────────────────────────────────────────────
