...
const en = {
  ...
  pricing: {
    navLabel: 'Pricing',
    eyebrow: '// PRICING · SALES-LED',
    title: 'Priced like an engagement.',
    sub: 'Tensol is sold per engagement, not per seat. Every package is scoped against your target footprint, your authorization model, and your compliance regime. We talk first, then we quote.',
    ...
    plans: [
      {
        ...
        priceAlt: '',
        unit: '/per test',
        claim: 'A full pentest of one application',
        bestFor:
          'Lightweight applications with a modest set of CRUD resources, simple workflows and low integration complexity',
        depth: 'Equivalent to a 2-week manual penetration test',
      },
      {
        name: 'Premium',
        price: '$3,500',
        priceAlt: '',
        unit: '/per test',
        claim: 'Deeper coverage for complex applications',
        bestFor:
          'Applications and platforms with multiple functional modules, integrations and multi-step workflows. Deeper access-control patterns and data models',
        depth: 'Equivalent to a 4-week manual penetration test',
      },
    ],
    faqEyebrow: '// FAQ',
...
const ru: TensolDict = {
  ...
  pricing: {
    navLabel: 'Тарифы',
    eyebrow: '// ТАРИФЫ',
    title: 'Цена соразмерна объёму работ',
    sub: 'Tensol тарифицируется по проекту, а не по числу пользователей. Каждый пакет рассчитывается под ваш периметр, модель авторизации и требования регулятора. Сначала — разговор о задаче, затем — коммерческое предложение.',
    ...
    plans: [
      {
        ...
        priceAlt: '',
        unit: 'за тест',
        claim: 'Полноценный пентест одного приложения',
        bestFor:
          'Приложения с ограниченным набором ресурсов, простыми бизнес-процессами и низкой сложностью интеграций',
        depth: 'Эквивалент двух недель ручного пентеста',
      },
      {
        name: 'Premium',
        price: '≈ 350 000 ₽',
        priceAlt: '',
        unit: 'за тест',
        claim: 'Глубокое покрытие сложных приложений',
        bestFor:
          'Приложения и платформы с несколькими функциональными модулями, интеграциями и многошаговыми сценариями. Более сложные модели доступа и данных',
        depth: 'Эквивалент четырёх недель ручного пентеста',
      },
    ],
    faqEyebrow: '',
