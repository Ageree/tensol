...
This project is indexed by GitNexus as **пентест ИИ** (987 symbols, 1544 relationships, 4 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
