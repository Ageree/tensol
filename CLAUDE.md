...
This project is indexed by GitNexus as **пентест ИИ** (576 symbols, 707 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
