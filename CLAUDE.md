...
This project is indexed by GitNexus as **пентест ИИ** (6021 symbols, 12846 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
