...
This project is indexed by GitNexus as **пентест ИИ** (464 symbols, 494 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
