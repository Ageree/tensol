...
This project is indexed by GitNexus as **пентест ИИ** (628 symbols, 790 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
