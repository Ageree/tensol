...
This project is indexed by GitNexus as **пентест ИИ** (2532 symbols, 5411 relationships, 115 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
