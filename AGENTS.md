...
This project is indexed by GitNexus as **пентест ИИ** (6027 symbols, 12857 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
