...
This project is indexed by GitNexus as **пентест ИИ** (2649 symbols, 5572 relationships, 122 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
