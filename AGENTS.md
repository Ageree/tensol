...
This project is indexed by GitNexus as **пентест ИИ** (5241 symbols, 10714 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
