...
This project is indexed by GitNexus as **пентест ИИ** (682 symbols, 885 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
