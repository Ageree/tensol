...
This project is indexed by GitNexus as **пентест ИИ** (6024 symbols, 12770 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
