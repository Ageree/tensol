...
This project is indexed by GitNexus as **пентест ИИ** (1057 symbols, 1704 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
