...
This project is indexed by GitNexus as **пентест ИИ** (2727 symbols, 5725 relationships, 122 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
