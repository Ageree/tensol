...
This project is indexed by GitNexus as **пентест ИИ** (662 symbols, 847 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
