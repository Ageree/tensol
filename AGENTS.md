...
This project is indexed by GitNexus as **пентест ИИ** (2776 symbols, 5968 relationships, 132 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
