...
This project is indexed by GitNexus as **пентест ИИ** (764 symbols, 1106 relationships, 3 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
