...
This project is indexed by GitNexus as **пентест ИИ** (2223 symbols, 4688 relationships, 99 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
