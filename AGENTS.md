...
This project is indexed by GitNexus as **пентест ИИ** (1291 symbols, 2275 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
