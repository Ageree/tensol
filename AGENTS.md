...
This project is indexed by GitNexus as **пентест ИИ** (1645 symbols, 3303 relationships, 70 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
