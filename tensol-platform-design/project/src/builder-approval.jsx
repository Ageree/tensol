  ...
  return (
    <div data-screen-label="07 App — assessment builder">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 24 }}>
        <div>
          <Eyebrow>{`// project: core-banking-prod · operator: ${TENSOL_DATA.user.name}`}</Eyebrow>
          <h1 style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 500, fontSize: 38, lineHeight: 1.05, letterSpacing: '-0.02em', margin: '6px 0 0' }}>{t.bldTitle}</h1>
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 14.5, color: 'var(--fg-2)', margin: '6px 0 0' }}>{t.bldSub}</p>
        </div>
...
function ApprovalScreen({ onRoute, role }) {
  ...
  return (
    <div data-screen-label="08 App — approval">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 24 }}>
        <div>
          <Eyebrow>// approval queue · 1 of 1</Eyebrow>
          <h1 style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 500, fontSize: 38, letterSpacing: '-0.02em', margin: '6px 0 0' }}>{t.apprTitle}</h1>
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 14.5, color: 'var(--fg-2)', margin: '6px 0 0' }}>{t.apprSub}</p>
        </div>
        <div style={{ display: 'flex', gap: 8 }}>
